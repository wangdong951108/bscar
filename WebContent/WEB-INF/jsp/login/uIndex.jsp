  ...
  <!--header-->
		...
		<div class="header-top">
			...
			<div class="header-top-in">			
				<div class="logo">
						<a href=""></a>
					<h1><span style="color: white;">闪电租车</span></h1>
				</div>
				<div class="header-in">
			...
			<div class="h_menu4">
				...
				<ul class="nav">
					<li class="active"><a href="${ctx}/login_index.do?role=1"><i> </i>首页</a></li>
					  <li ><a href="#" ></a></li> 	
					  <li style="margin-left: 30px;"><a href="${ctx}/user_myInfo.do" >个人中心</a></li>  
					    <li style="margin-left: 30px;"><a href="${ctx}/car_addMyCar.do" >我要发布</a></li>
					     <li style="margin-left: 30px;"><a href="${ctx}/order_rentInfoList.do">我的个人租车记录</a></li>  
					    <li style="margin-left: 30px;"><a href="${ctx}/order_rentInfoList1.do" >我的商家租车记录</a></li>    
					    <li style="margin-left: 30px;"><a href="${ctx}/order_rentInfoList2.do" >我的被租车记录</a></li>             
						<li style="margin-left: 30px;"><a href="${ctx}/order_findOrderByUserId.do" >我的订单</a></li>							  				 
...
<!-- 		<div class="clearfix"></div> -->
		<div class="container">
			<div class="products">
					<h2 class=" products-in">新车推荐 &nbsp;&nbsp;<a href="${ctx}/car_uCarList.do"><span style="color: red">更多>>></span></a></h2>
							...
							<div class="col-md">
								...
								<div class="top-content">
									<div class="white">
										...
										<p class="dollar"><span class="in-dollar">￥${newest.carPrice}</span></p>
										<div class="clearfix"></div>
									</div>
								</div>							
						 	</div>
							...
							<div class="col-md">
								...
								<div class="top-content">
									...
									<p class="hvr-shutter-in-vertical hvr-shutter-in-vertical2 "><span class="in-dollar">${recommend.carType}</span></p>
										<p class="dollar"><span class="in-dollar">￥${recommend.carPrice}</span></p>
										<div class="clearfix"></div>
									</div>
								</div>							
							</div>
				...
				<div class="clearfix"></div>
							...
							<div class="col-md">
								...
								<div class="top-content">
									<div class="white">
										...
										<p class="dollar"><span class="in-dollar">￥${discount.carPrice}</span></p>
										<div class="clearfix"></div>
									</div>
								</div>							
							</div>
					...
					<div class="clearfix"></div>
					<div class="products">
					<h2 class="products-in">个人租车 &nbsp;&nbsp;<a href="${ctx}/car_uCarList.do?flag=2"><span style="color: red">更多>>></span></a></h2>
					 <c:forEach items="${personList}" var="person" varStatus="l">
						 <c:if test="${(l.index) % 4 == 0 }">
						  <div class="top-products">
						 </c:if>
						  <div class="col-md-3 md-col">
							<div class="col-md">
								<a href="${ctx}/car_uCar.do?id=${person.id}"><img  src="${person.carImage}" alt="${person.carType}" style="width: 239.21px;height: 150.71px"/></a>	
								<div class="top-content">
									<div class="white">
										<p class="hvr-shutter-in-vertical hvr-shutter-in-vertical2 "><span class="in-dollar">${person.carType}</span></p>
										<p class="dollar"><span class="in-dollar">￥${person.carPrice}</span></p>
										<div class="clearfix"></div>
									</div>
								</div>							
							</div>
					...
					<div class="clearfix"></div>
					<div class="products">
					<h2 class="products-in">商家租车 &nbsp;&nbsp;<a href="${ctx}/car_uCarList.do?flag=1"><span style="color: red">更多>>></span></a></h2>
					 <c:forEach items="${businessList}" var="business" varStatus="l">
						 <c:if test="${(l.index) % 4 == 0 }">
						  <div class="top-products">
						 </c:if>
						  <div class="col-md-3 md-col">
							<div class="col-md">
								<a href="${ctx}/car_uCar.do?id=${business.id}"><img  src="${business.carImage}" alt="${business.carType}" style="width: 239.21px;height: 150.71px"/></a>	
								<div class="top-content">
									<div class="white">
										<p class="hvr-shutter-in-vertical hvr-shutter-in-vertical2 "><span class="in-dollar">${business.carType}</span></p>
										<p class="dollar"><span class="in-dollar">￥${business.carPrice}</span></p>
										<div class="clearfix"></div>
									</div>
								</div>							
							</div>
