...
<body>
<form action="user_exUpdate.do" method="post" class="definewidth m20" id="hh">
<table class="table table-bordered table-hover definewidth m10">
     <tr>
        <td width="10%" class="tableleft">用户ID</td>
        <td><input type="text" name="id" id="id" value="${user.id}" disabled="disabled"/>
        <input type="hidden" name="id" id="id" value="${user.id}"/>
        </td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">用户名</td>
        <td><input type="text" name="loginName" id="loginName" value="${user.loginName}" readonly="readonly"/>
        </td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">用户姓名</td>
        <td><input type="text" name="realName" id="realName" value="${user.realName}" readonly="readonly"/>
        </td>
    </tr>
     <tr>
