	...
	<div class="container cart">
		<div class="span24">
			<div class="step step1">
				<ul>
					<li class="current"></li>
					 <li style="margin-left: 170px;color: red;font-size: 25px; list-style-type:none">订单详情</li>
				</ul>
			</div>
			<table>
				<tbody>
                             ...
                             <tr>
                               ...
                               <tr>
                                <th></th>
                                 <td>
                                   <a href="${ctx}/order_getByOrderId.do?id=${order.id}&flag=2" style="color: red">修改订单</a>
                                  </td>
                                </tr> 
                               </c:if>
				</tbody>
