...
<body>
<form action="admin_exAdd.do" method="post" class="definewidth m20" id="hh">
<table class="table table-bordered table-hover definewidth m10">
    <tr>
        <td width="10%" class="tableleft">管理员名</td>
        <td><input type="text" name="adminName" id="adminName" value="${admin.adminName}"/></td>
    </tr>
     <tr>
