<%@page import="com.wangdbysj.model.User"%>
		...
		<div class="account">
			...
			<div>
				...
				<input type="text" name="phone" id="phone"
					value="<%=session.getAttribute("phone")%>" readonly="readonly">
			</div>
			<div>
				<span>&nbsp;新密码&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
			...
			<div>
				<span>确认新密码&nbsp;&nbsp;</span> <input type="password"
					name="passWord1" id="passWord1"<!--  onblur="checkRspassword() -->">
			</div>
			<input type="submit" value="修改密码" style="margin-left: 150px;"
				onclick="checkRspassword()" />
		</div>
	</div>
...
<script>
	...
	function checkRspassword() {
		...
		if (password != password1) {
			...
			var passWord = $("#passWord").val();
			$.ajax({
				url : ctx + '/user_phUpdatePassWord.do',
				type : 'POST',
				dataType : 'json',
				data : {
